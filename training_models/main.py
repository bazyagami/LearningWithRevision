...
from data import load_cifar100, load_mnist, load_imagenet, load_cifar10, load_medmnist3D
...
def main():
    ...
    if args.dataset == "mnist":
        ...
        if args.batch_size:
            train_loader, test_loader, data_size = load_cifar100(args.batch_size)
        else:
            train_loader, test_loader = load_cifar100()
        num_classes = 100
    elif args.dataset == "cifar10":
        train_loader, test_loader, data_size = load_cifar10(args.batch_size)
        num_classes = 10
    ...
    effective_epoch = int(num_step/data_size)
    print("The effective epochs are:", effective_epoch)
